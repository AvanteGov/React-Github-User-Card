...
## Retrospective: 
I believe given the expereince of both methodologies the best practice (as with most things in life) lies somewhere in the middle of the two- using one or the other when it is most suitable. Building the application explicitly one way or the other has its own inherent nature of challenges that the opposite can stand to mitigate. 
